About s3contents-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/s3contents-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4319&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/s3contents-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `s3contents` can be installed with `conda`:
...
```
mamba install s3contents
```

It is possible to list all of the versions of `s3contents` available on your platform with `conda`:
...
```
mamba search s3contents --channel conda-forge
```
...
mamba repoquery search s3contents --channel conda-forge

# List packages depending on `s3contents`:
mamba repoquery whoneeds s3contents --channel conda-forge

# List dependencies of `s3contents`:
mamba repoquery depends s3contents --channel conda-forge
```
